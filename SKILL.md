---
name: xxd-panel-046
description: "Create XXD Panel 046 raster artwork while treating the bundled original style brief as the sole aesthetic authority. Supports one or more top-bottom, left-right, design-only, and four-device wallpaper outputs; multiple ratios or exact sizes; prompt-generated, user-exact, or text-free typography; and inline parameters. Use when the user invokes xxd-panel-046 or requests the exact Panel 046 style."
---
...
```text
/xxd-panel-046 <source> --mode top-bottom,design-only \
