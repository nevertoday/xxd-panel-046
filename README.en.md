...
**Panel 046** is suited to work that must retain the source's essential content while pursuing this visual direction: **Rebuild a photograph as a bright, vivid, tactile impasto micro-landscape**. It begins with intended use and desired outcome; layout, size, text, and delivery format follow from those needs.
...
> Use XXD Panel 046 on this image and recommend the best layout and size first.
...
/xxd-panel-046 photo.jpg --mode top-bottom --size auto --text prompt --locale en-GB
...
/xxd-panel-046 photo.jpg --mode design-only --size 3:4 --text prompt --locale en-GB

# Use exact copy without rewriting, translating, or adding a title
/xxd-panel-046 photo.jpg --mode design-only --size 3:4 --copy "Let the light stay" --locale en-GB

# Two modes × three sizes produce six independently composed assets
/xxd-panel-046 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale en-GB

# Apply Panel 046 to a whole directory; shared settings resolve once
/xxd-panel-046 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale en-GB
